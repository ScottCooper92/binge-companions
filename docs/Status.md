...
| PLAYER | `com.binge.integration.PLAYER` | Deferred | The Play sheet and the intents to installed players cover the hand-off for now. See `Architecture.md` > Where LIBRARY stops for what would bring it back. |
